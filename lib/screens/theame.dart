...
import 'package:sp_ask_dashboard_mobile_app_layout/screens/hexpoint.dart';
...
TextStyle boldNumberRed = TextStyle(color: Colors.red, fontWeight: FontWeight.bold,fontSize: 50.0);
TextStyle headlineTitle = TextStyle(color: HexColor("fbfbfb"), fontWeight: FontWeight.bold,fontSize: 30.0);
